      ...
      position => {
        this.setState({
          ...
          longitudeMarker: position.coords.longitude
                        ...
                        return fetch('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location='+this.state.latitude+','+this.state.longitude+'&radius=1000&type=park&key='+ApiKey+'')
          ...
          <View style={styles.container}>
              ...
              <TouchableOpacity style={styles.header} onPress={()=> this.props.navigation.goBack()}>
                       <Icon name="arrow-left" size={28} style={styles.icon}/>
                            <View>
                                <Text style={styles.headerText}>DOG PARKS</Text>
                            </View>
               </TouchableOpacity>
